 ...
 * 通用上架记录界面
 */
public abstract class LaunchRecordUI extends Chest {
     ...
     * @param strategy 市场策略
     */
    public LaunchRecordUI(String title, int size, MarketStrategy strategy) {
        super(title, size);
     ...
     * @return 下架确认按钮
     */
    protected ItemStack createDelistButton(String id) {
        ItemStack item = new ItemStack(Material.BARRIER);
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName("§c下架");
